...
with open(os.path.join('notebooks', 'supplementary_analysis.ipynb'), 'w', encoding='utf-8') as f:
    json.dump(nb, f, indent=2)

print('Generated notebooks/supplementary_analysis.ipynb successfully.')
